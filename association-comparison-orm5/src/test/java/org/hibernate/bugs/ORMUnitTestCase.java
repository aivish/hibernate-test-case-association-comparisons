...
public class ORMUnitTestCase extends BaseCoreFunctionalTestCase {
    ...
    public void hhh123CanUpdateByAssociation() {
        ...
        // when
        int affectedComments = s.createQuery("UPDATE Comment c SET c.text = :text WHERE c.user = :user")
    ...
    public void hhh123CanDeleteByAssociation() {
        ...
        // when
        int affectedComments = s.createQuery("DELETE FROM Comment c WHERE c.user = :user")
                .setParameter("user", user1)
                .executeUpdate();
